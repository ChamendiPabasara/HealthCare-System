...
public class PaymentService {
	...
	public String addPayment(@NotEmpty(message = "Card type can't be empty") @FormParam("cardType") String cardType,
			@NotNull(message = "Card Number can't be empty") @FormParam("cardNumber") int cardNumber,
			@Pattern(regexp="^[a-z A-Z]*$", message="Can't use numbers on this feild") @NotNull(message = "Name on card can't be empty") @FormParam("nameOnCard") String nameOnCard,
	...
	public String updatePaymentById(@QueryParam("patientId") int id ,
			...
			@NotEmpty(message = "Name on card can't be empty") @FormParam("nameOnCard") String nameOnCard,
